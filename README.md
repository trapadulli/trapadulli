...
Solfège-based music education platform — interactive web app with real-time AI pitch recognition, iOS native shell, and a PyTorch/Whisper ML pipeline for syllable classification.
`React · TypeScript · Node.js · PostgreSQL · ONNX · Capacitor`

### [MapStreamKit](https://github.com/trapadulli/MapStreamKit)
Event-driven ingestion and control-plane that pulls external API data, normalizes it, and exposes it through a read API layer—infrastructure as code.
...
Boilerplate shell for wrapping any remote web application inside a WebView for iOS (and optionally Android). 
`Capacitor · TypeScript · iOS (Swift) · WebView · AdMob · RevenueCat`

### [SimTrade](https://github.com/SimTrade)
Quantitative algorithmic trading infrastructure — equity data ingest pipeline and backtester/live-trader running against brokerage APIs.
